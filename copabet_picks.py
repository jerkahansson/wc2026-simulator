...
MATCHES = [
    ...
    # Group C
    ("C", 1, "USA", "Paraguay", 2.02, 3.45, 4.25),
    ("C", 1, "Australia", "Turkey", 5.40, 3.80, 1.75),
    ("C", 2, "USA", "Australia", 1.81, 3.90, 5.05),
    ("C", 2, "Turkey", "Paraguay", 2.30, 3.30, 3.50),
    ("C", 3, "Paraguay", "Australia", 2.23, 3.30, 3.60),
    ("C", 3, "Turkey", "USA", 2.75, 3.50, 2.63),
    # Group D
    ("D", 1, "Brazil", "Morocco", 1.70, 3.85, 5.60),
    ("D", 1, "Haiti", "Scotland", 6.50, 4.75, 1.55),
    ("D", 2, "Scotland", "Morocco", 4.25, 3.35, 2.02),
    ("D", 2, "Brazil", "Haiti", 1.10, 14.00, 46.00),
    ("D", 3, "Scotland", "Brazil", 8.90, 4.80, 1.47),
    ("D", 3, "Morocco", "Haiti", 1.34, 5.25, 12.00),
    # Group E
    ...
    # Group G
    ("G", 1, "Spain", "Cape Verde", 1.11, 13.00, 37.00),
    ("G", 1, "Saudi Arabia", "Uruguay", 8.50, 4.50, 1.45),
    ("G", 2, "Spain", "Saudi Arabia", 1.13, 10.00, 35.00),
    ("G", 2, "Uruguay", "Cape Verde", 1.47, 4.50, 8.10),
    ("G", 3, "Cape Verde", "Saudi Arabia", 2.62, 3.50, 2.72),
    ("G", 3, "Uruguay", "Spain", 5.35, 3.90, 1.70),
    # Group H
    ("H", 1, "Belgium", "Egypt", 1.70, 3.90, 5.75),
    ("H", 1, "Iran", "New Zealand", 1.95, 3.40, 4.60),
    ("H", 2, "Belgium", "Iran", 1.44, 4.80, 8.50),
    ("H", 2, "New Zealand", "Egypt", 5.35, 3.76, 1.75),
    ("H", 3, "Egypt", "Iran", 2.40, 3.05, 3.60),
    ("H", 3, "New Zealand", "Belgium", 11.00, 6.00, 1.34),
    # Group I
